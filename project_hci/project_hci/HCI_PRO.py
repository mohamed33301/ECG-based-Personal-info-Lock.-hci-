...
pickle.dump(LDA_classifier,open('D:\Downloads\sav_mo\LDA_classifier_fiducial.pkl','wb'))
...
path=r"D:\Downloads\project_hci\sub_4_test_segment.txt" 
...
loaded_model=pickle.load(open('D:\Downloads\sav_mo\LDA_classifier_fiducial.pkl','rb'))
